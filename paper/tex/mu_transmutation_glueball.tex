...
The law itself is not new, and we do not claim it: it is the established
contact-term result with the single substitution
\(\Lambda_{\rm QCD} \to \Lambda_{\rm hidden}\). The contribution here is
(i) fixing \(\mu\) by dimensional transmutation of a hidden \(SU(3)\),
and (ii) tying the same sector to glueball dark matter. Notably the same
\(H\)-linear form is reached from an entirely different route --- a
volume-law horizon entropy gives \(\rho \propto H\) in entropic
cosmology \citep{Komatsu:2015nkb, Komatsu:2012zh} --- so
